...
@section('content')
@php
    // Resolve recipient tz with the same priority used by the
    // confirmation/reminder mails. $patient may not be in scope here
    // (cancel mailable doesn't always pass it) — guard each lookup.
